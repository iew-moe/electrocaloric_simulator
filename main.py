...
def update_heatmap(): 
    ...
    if num_plates % 2 == 0:
        y_fluid_pos = ny/2-0.5
        y_material_pos = y_fluid_pos - (plate_height + plate_spacing)/2-0.5
    else:
        y_fluid_pos = ny/2 + (plate_height + plate_spacing)/2-0.5
        y_material_pos = ny/2-0.5
